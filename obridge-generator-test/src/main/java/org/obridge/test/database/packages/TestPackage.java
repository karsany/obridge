...
public final class TestPackage {
    ...
    private static final java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(TestPackage.class.getName());
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.getSysdate1 called");
            ocs.execute();
            LOGGER.info("TestPackage.getSysdate1 executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.getSysdate2 called");
            ocs.execute();
            LOGGER.info("TestPackage.getSysdate2 executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.helloWorld called");
            ocs.execute();
            LOGGER.info("TestPackage.helloWorld executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.booleanTest2 called");
            ocs.execute();
            LOGGER.info("TestPackage.booleanTest2 executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.booleanTest1 called");
            ocs.execute();
            LOGGER.info("TestPackage.booleanTest1 executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.objectTypeTest1 called");
            ocs.execute();
            LOGGER.info("TestPackage.objectTypeTest1 executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.tableOfTest1 called");
            ocs.execute();
            LOGGER.info("TestPackage.tableOfTest1 executed");
            ctx.setFunctionReturn(ocs.getBigDecimal(1)); // null
    ...
    try {
        ...
        try {
            ...
            ocs.setObject(2, SampleTypeOneConverter.getListArray(ctx.getListOf(), connection, "SAMPLE_TYPE_ONE_LIST"));
            ocs.registerOutParameter(2, Types.ARRAY, "SAMPLE_TYPE_ONE_LIST"); // P_LIST_OF
            LOGGER.info("TestPackage.combinedTypesTest1 called");
            ocs.execute();
            LOGGER.info("TestPackage.combinedTypesTest1 executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.allTypes called");
            ocs.execute();
            LOGGER.info("TestPackage.allTypes executed");
    ...
    try {
        final CallableStatement ocs = connection.prepareCall(                "" +
                                      ...
                                      "");
        try {
            LOGGER.info("TestPackage.quotedProcedureName called");
            ocs.execute();
            LOGGER.info("TestPackage.quotedProcedureName executed");
        } finally  {
            ocs.close();
        }
    } catch (SQLException e) {
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.isitagoodfunction called");
            ocs.execute();
            LOGGER.info("TestPackage.isitagoodfunction executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.functionReturnsBoolean called");
            ocs.execute();
            LOGGER.info("TestPackage.functionReturnsBoolean executed");
            ctx.setFunctionReturn(null == ocs.getBigDecimal(1) ? null : BigDecimal.ONE.equals(ocs.getBigDecimal(1)) ? true : BigDecimal.ZERO.equals(ocs.getBigDecimal(1)) ? false : null); // null
        } finally  {
            ocs.close();
        }
    ...
    try {
        ...
        try {
            ocs.registerOutParameter(1, Types.INTEGER); // null
            LOGGER.info("TestPackage.simpleBooleanReturn called");
            ocs.execute();
            LOGGER.info("TestPackage.simpleBooleanReturn executed");
            ctx.setFunctionReturn(null == ocs.getBigDecimal(1) ? null : BigDecimal.ONE.equals(ocs.getBigDecimal(1)) ? true : BigDecimal.ZERO.equals(ocs.getBigDecimal(1)) ? false : null); // null
        } finally  {
            ocs.close();
        }
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.returnStringList called");
            ocs.execute();
            LOGGER.info("TestPackage.returnStringList executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.sumList called");
            ocs.execute();
            LOGGER.info("TestPackage.sumList executed");
            ctx.setFunctionReturn(ocs.getBigDecimal(1)); // null
        } finally  {
            ocs.close();
        }
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.testManyNameList called");
            ocs.execute();
            LOGGER.info("TestPackage.testManyNameList executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("TestPackage.testManyNameMany called");
            ocs.execute();
            LOGGER.info("TestPackage.testManyNameMany executed");
