...
public final class ProceduresAndFunctions {
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("ProceduresAndFunctions.execfunction called");
            ocs.execute();
            LOGGER.info("ProceduresAndFunctions.execfunction executed");
    ...
    try {
        ...
        try {
            ...
            LOGGER.info("ProceduresAndFunctions.testProcedure called");
            ocs.execute();
            LOGGER.info("ProceduresAndFunctions.testProcedure executed");
